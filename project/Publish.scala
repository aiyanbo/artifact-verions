...
object Publish extends AutoPlugin {
  ...
  override def projectSettings: Seq[_root_.sbt.Def.Setting[_]] = Seq(
    ...
    pomExtra :=
      <url>https://github.com/aiyanbo/artifact-verions</url>
      <licenses>
        <license>
      ...
      <scm>
        <url>git@github.com/aiyanbo/artifact-verions.git</url>
        <connection>scm:git:git@github.com/aiyanbo/artifact-verions.git</connection>
      </scm>
      <developers>
        <developer>
          <id>yanbo.ai</id>
